...
exports.run = async (client, message, args) => {
  ...
  if(!user){
    ...
    .addField("HATA", `Bir kullanıcıyı etiketlemelisin!`)
    .addField("Doğru kullanım", `${prefix}ban [@kullanıcı] [sebep]`)
    ...
    if(modak !== "Kapalı"){
      ...
      .setTitle(`${ayarlar.moderasyon_title}`)
      .addField("GG", `${user} şahsiyeti ${message.author} tarafından banlandı`)
    ...
    if(modak === "Kapalı"){
      ...
      if(modkanal !== "yok"){
        ...
        .setTitle(`${ayarlar.moderasyon_title}`)
        .addField("Merhaba", `Bu komutu kullanmaya yetkin yok!`)
...
exports.help = {
  name: 'ban',//buraya komutun adını yaz.
  description: 'ban',//burda komutun açıklamasını yazıyoruz.
  usage: 'ban'//buraya komut nasıl kullanılır onu yazdım.d! yerine istediğin prefixi yaz.
}
